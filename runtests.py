...
if args.integration:
    ...
    for env_var in ['DJANGO_MEDICARE_SLSX_LOGIN_URI', 'DJANGO_MEDICARE_SLSX_REDIRECT_URI',
                    'DJANGO_MEDICARE_SLSX_REDIRECT_URI_V1', 'DJANGO_SLSX_USERINFO_ENDPOINT',
                    'DJANGO_SLSX_TOKEN_ENDPOINT', 'DJANGO_SLSX_HEALTH_CHECK_ENDPOINT',
                    "DJANGO_SLSX_SIGNOUT_ENDPOINT", 'DATABASES_CUSTOM',
    ...
    for env_var in ['FHIR_URL', 'DJANGO_MEDICARE_SLSX_LOGIN_URI', 'DJANGO_MEDICARE_SLSX_REDIRECT_URI',
                    'DJANGO_MEDICARE_SLSX_REDIRECT_URI_V1', 'DJANGO_SLSX_USERINFO_ENDPOINT',
                    'DJANGO_SLSX_TOKEN_ENDPOINT', 'DJANGO_SLSX_HEALTH_CHECK_ENDPOINT',
                    "DJANGO_SLSX_SIGNOUT_ENDPOINT", 'DJANGO_FHIR_CERTSTORE',
