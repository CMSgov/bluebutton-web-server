...
<h2>Enter values to be returned by the SLSX user_info endpoint below:</h2>
</p>
<br>
<br>
<h2>{{.HelpMessage}}</h2>
...
<div>
    ...
    <br>
    <br>
    <label>first_name</label> <input type="text" name="first_name" size=50></input>
    <br>
    <br>
    <label>last_name</label> <input type="text" name="last_name" size=50></input>
    <br>
    <br>
