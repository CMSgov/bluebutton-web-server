/*
 ...
 bb2.prod_global_state_per_app being updated
 first via the 
 bb2.vw_prod_global_state_per_app view.
...
WITH report_date_range AS (
  ...
  */
  /*
   ...
   bb2.prod_global_state table via the select below: */
  SELECT
    (
      SELECT
        date_trunc('week', MAX(report_date))
      FROM
        bb2.prod_global_state
    ) AS min_report_date,
  ...
  (
    SELECT
      ...
      /*
       ...
       per the vw_prod_global_state_per_app view
