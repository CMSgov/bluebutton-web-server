...
| <a name="input_github_repo_pattern"></a> [github\_repo\_pattern](#input\_github\_repo\_pattern) | GitHub repository pattern for OIDC trust policy (supports wildcards). Defaults to all BB repos. | `string` | `"bluebutton*"` | no |
...
| <a name="input_iam_path"></a> [iam\_path](#input\_iam\_path) | IAM path for roles | `string` | `"/delegatedadmin/developer/"` | no |
...
| <a name="input_static_site_github_repo_url"></a> [static\_site\_github\_repo\_url](#input\_static\_site\_github\_repo\_url) | GitHub repository URL for bb-site-static CodeBuild | `string` | `"https://github.com/CMSgov/bluebutton-site-static"` | no |
...
| [aws_cloudwatch_log_group.static_site](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_log_group) | resource |
...
| [aws_codebuild_project.static_site](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/codebuild_project) | resource |
...
| [aws_codebuild_webhook.static_site](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/codebuild_webhook) | resource |
...
| [aws_iam_policy.static_site_codebuild_base](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
| [aws_iam_policy.static_site_secrets_manager](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
| [aws_iam_role.codebuild](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role.codebuild_static_site](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
...
| [aws_iam_role_policy.github_actions_ecs_deploy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
| [aws_iam_role_policy.github_actions_tofu](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
...
| [aws_iam_role_policy.static_site_github](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
| [aws_iam_role_policy.static_site_kms](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
| [aws_iam_role_policy.static_site_logs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
| [aws_iam_role_policy_attachment.static_site_codebuild_base](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.static_site_secrets_manager](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_ecr_repository.shared](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ecr_repository) | data source |
...
| [aws_iam_policy_document.github_actions_ecs_deploy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.github_actions_tofu](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.kms](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.logs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.secrets](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.static_site_github](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.static_site_kms](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.static_site_logs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_role.github_actions](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_role) | data source |
...
| <a name="output_static_site_codebuild_project_arn"></a> [static\_site\_codebuild\_project\_arn](#output\_static\_site\_codebuild\_project\_arn) | ARN of the bb-site-static CodeBuild project |
| <a name="output_static_site_codebuild_project_name"></a> [static\_site\_codebuild\_project\_name](#output\_static\_site\_codebuild\_project\_name) | Name of the bb-site-static CodeBuild project |
| <a name="output_static_site_codebuild_role_arn"></a> [static\_site\_codebuild\_role\_arn](#output\_static\_site\_codebuild\_role\_arn) | ARN of the bb-site-static CodeBuild service role |
<!-- END_TF_DOCS -->