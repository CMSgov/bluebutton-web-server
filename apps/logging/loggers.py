...
def log_global_state_metrics(group_timestamp=None, report_flag=True, its_log_flag=False):
    ...
    log_dict = {
        ...
        'real_bene_cnt': crosswalk_counts.get('real', None),  # TODO: Deprecate this duplicate name in future
        'synth_bene_cnt': crosswalk_counts.get('synthetic', None),  # TODO: Deprecate this duplicate name in future
        ...
        'grant_synthetic_bene_deduped_count': grant_counts.get('synthetic_deduped', None),
        ...
        'token_real_bene_app_pair_deduped_count': access_token_counts.get('real_bene_app_pair_deduped', None),
        'token_synthetic_bene_app_pair_deduped_count': access_token_counts.get('synthetic_bene_app_pair_deduped', None),
        'token_deduped_counts_elapsed': access_token_counts.get('deduped_elapsed', None),
        ...
        'global_beneficiary_real_grant_count': beneficiary_counts.get('real_grant', None),
        'global_beneficiary_synthetic_grant_count': beneficiary_counts.get('synthetic_grant', None),
        'global_beneficiary_grant_archived_count': beneficiary_counts.get('total_grant_archived', None),
        'global_beneficiary_real_grant_archived_count': beneficiary_counts.get('real_grant_archived', None),
        ...
        'global_beneficiary_app_pair_counts_elapsed': beneficiary_app_pair_counts.get('elapsed', None),
    }
