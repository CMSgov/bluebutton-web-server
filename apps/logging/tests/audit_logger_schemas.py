...
MATCH_FHIR_ID_LOG_SCHEMA = {
    ...
    "type": "object",
    "properties": {
        "type": {"type": "string", "pattern": "^fhir.server.authentication.match_fhir_id$"},
        "auth_uuid": {"type": "null"},
        ...
        "hicn_hash": {"type": "string", "pattern": "^f7dd6b126d55a6c49f05987f4aab450deae3f990dcb5697875fd83cc61583948$"},
        ...
        "hash_lookup_mesg": {"type": "string", "pattern": "^FOUND beneficiary via mbi_hash$"},
    },
...
MYMEDICARE_CB_GET_UPDATE_BENE_LOG_SCHEMA = {
    ...
    "properties": {
        ...
        "subject": {"type": "string", "pattern": "^00112233-4455-6677-8899-aabbccddeeff$"},
        "user_username": {"type": "string", "pattern": "^00112233-4455-6677-8899-aabbccddeeff$"},
        "fhir_id": {"type": "string", "pattern": "^-20140000008325$"},
        "hicn_hash": {"type": "string", "pattern": "^f7dd6b126d55a6c49f05987f4aab450deae3f990dcb5697875fd83cc61583948$"},
        "mbi_hash": {"type": "string", "pattern": "^4da2e5f86b900604651c89e51a68d421612e8013b6e3b4d5df8339d1de345b28$"},
        "hash_lookup_type": {"type": "string", "pattern": "^M$"},
    ...
    "required": ["type", "status", "subject", "user_username", "fhir_id", "hicn_hash", "mbi_hash", "crosswalk",
                 "hicn_updated", "mbi_updated", "mbi_updated_from_null", "mesg", "request_uuid", "crosswalk_before"]
}
