...
GLOBAL_STATE_METRICS_LOG_SCHEMA = {
    ...
    "properties": {
        ...
        "global_beneficiary_token_count": {"type": "number"},
        "global_beneficiary_real_token_count": {"type": "number"},
        "global_beneficiary_synthetic_token_count": {"type": "number"},
        "global_beneficiary_token_archived_count": {"type": "number"},
        "global_beneficiary_real_token_archived_count": {"type": "number"},
        "global_beneficiary_synthetic_token_archived_count": {"type": "number"},
        "global_beneficiary_token_or_archived_count": {"type": "number"},
        "global_beneficiary_real_token_or_archived_count": {"type": "number"},
        "global_beneficiary_synthetic_token_or_archived_count": {"type": "number"},
        "global_beneficiary_token_and_archived_count": {"type": "number"},
        "global_beneficiary_real_token_and_archived_count": {"type": "number"},
        "global_beneficiary_synthetic_token_and_archived_count": {"type": "number"},
        "global_beneficiary_token_not_archived_count": {"type": "number"},
        "global_beneficiary_real_token_not_archived_count": {"type": "number"},
        "global_beneficiary_synthetic_token_not_archived_count": {"type": "number"},
        "global_beneficiary_archived_not_token_count": {"type": "number"},
        "global_beneficiary_real_archived_not_token_count": {"type": "number"},
        "global_beneficiary_synthetic_archived_not_token_count": {"type": "number"},
