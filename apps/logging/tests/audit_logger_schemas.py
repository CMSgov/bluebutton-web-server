...
GLOBAL_STATE_METRICS_LOG_SCHEMA = {
    ...
    "properties": {
        ...
        "bene_cnt_elapsed": {"type": "number"},
        "real_bene_grant_cnt": {"type": "integer"},
        "synth_bene_grant_cnt": {"type": "integer"},
        "bene_grant_cnt_elapsed": {"type": "number"},
        "real_bene_token_distinct_cnt": {"type": "integer"},
        "synth_bene_token_distinct_cnt": {"type": "integer"},
        "bene_token_distinct_cnt_elapsed": {"type": "number"},
        "real_bene_grant_distinct_cnt": {"type": "integer"},
        "synth_bene_grant_distinct_cnt": {"type": "integer"},
        "bene_grant_distinct_cnt_elapsed": {"type": "number"},
        "real_bene_grant_arch_distinct_cnt": {"type": "integer"},
        "synth_bene_grant_arch_distinct_cnt": {"type": "integer"},
        "bene_grant_arch_distinct_cnt_elapsed": {"type": "number"},
        "real_bene_grant_and_arch_union_cnt": {"type": "integer"},
        "synth_bene_grant_and_arch_union_cnt": {"type": "integer"},
        "bene_grant_and_arch_union_cnt_elapsed": {"type": "number"},
    ...
    "required": [
        ...
        "bene_cnt_elapsed",
        "real_bene_grant_cnt",
        "synth_bene_grant_cnt",
        "bene_grant_cnt_elapsed",
        "real_bene_token_distinct_cnt",
        "synth_bene_token_distinct_cnt",
        "bene_token_distinct_cnt_elapsed",
        "real_bene_grant_distinct_cnt",
        "synth_bene_grant_distinct_cnt",
        "bene_grant_distinct_cnt_elapsed",
        "real_bene_grant_arch_distinct_cnt",
        "synth_bene_grant_arch_distinct_cnt",
        "bene_grant_arch_distinct_cnt_elapsed",
        "real_bene_grant_and_arch_union_cnt",
        "synth_bene_grant_and_arch_union_cnt",
        "bene_grant_and_arch_union_cnt_elapsed",
