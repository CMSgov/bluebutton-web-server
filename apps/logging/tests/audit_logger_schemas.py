...
AUTHENTICATION_START_LOG_SCHEMA = {
    ...
    "properties": {
        ...
        "sls_healthcheck_status_code": {"type": "null"},
        "sls_healthcheck_status_mesg": {"pattern": "None"},
        "sls_signout_status_code": {"type": "integer", "enum": [302]},
        "sls_signout_status_mesg": {"pattern": "None"},
        "sls_token_status_code": {"type": "integer", "enum": [200]},
        "sls_token_status_mesg": {"pattern": "None"},
        "sls_userinfo_status_code": {"type": "integer", "enum": [200]},
        "sls_userinfo_status_mesg": {"pattern": "None"},
        "sls_validate_signout_status_code": {"type": "integer", "enum": [403]},
