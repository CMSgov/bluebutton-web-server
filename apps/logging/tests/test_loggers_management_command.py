...
TEST_GLOBAL_STATE_METRICS_PER_APP_LOG_SCHEMA = copy.deepcopy(GLOBAL_STATE_METRICS_PER_APP_LOG_SCHEMA)
...
class TestLoggersGlobalMetricsManagementCommand(BaseApiTest):
    ...
    def _validate_global_state_metrics_log(self, validate_dict):
        ...
        for f in fields_list:
            TEST_GLOBAL_STATE_METRICS_LOG_SCHEMA['properties'][f]['enum'] = [validate_dict[f]]

        # Validate with test schema copy.
        self.assertTrue(self._validateJsonSchema(TEST_GLOBAL_STATE_METRICS_LOG_SCHEMA, log_dict))

        # Validate with original schema copy.
        self.assertTrue(self._validateJsonSchema(GLOBAL_STATE_METRICS_LOG_SCHEMA, log_dict))
    ...
    def _validate_global_state_per_app_metrics_log(self, validate_apps_dict):
        ...
        for app_name in validate_apps_dict:
            ...
            # Update Json Schema
            TEST_GLOBAL_STATE_METRICS_PER_APP_LOG_SCHEMA['properties']['name']['pattern'] = app_name
    ...
    def test_management_command_logging(self):
        ...
        self._create_range_users_app_token_grant(
            start_fhir_id='4000000000000', count=3, app_name='app0', app_user_organization='app0-org'
        )

        # Create 2x synth benes -30000000000000 thru -30000000000001 connected to app1
        self._create_range_users_app_token_grant(
            start_fhir_id='-3000000000000', count=2, app_name='app1', app_user_organization='app1-org'
        )

        # Create 5x real benes 50000000000000 thru 50000000000004 connected to app1
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='5000000000000', count=5, app_name='app1', app_user_organization='app1-org'
        )
        ...
        app, ac_dict = self._create_range_users_app_token_grant(
            start_fhir_id='-4000000000000', count=2, app_name='app2', app_user_organization='app2-org'
        )
        ...
        validate_apps_dict['app0']['grant_and_archived_synthetic_bene_deduped_count'] = 5
        ...
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='-6000000000000', count=7, app_name='app0', app_user_organization='app0-org'
        )
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='-6000000000000', count=7, app_name='app1', app_user_organization='app1-org'
        )
        ...
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='-6000000000000', count=7, app_name='app3', app_user_organization='app3-org'
        )

        # Create 10x real benes 60000000000000 thru 60000000000009 connected to app0, app1 and app3
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='6000000000000', count=10, app_name='app0', app_user_organization='app0-org'
        )
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='6000000000000', count=10, app_name='app1', app_user_organization='app1-org'
        )
        ...
        app, user_dict = self._create_range_users_app_token_grant(
            start_fhir_id='6000000000000', count=10, app_name='app3', app_user_organization='app3-org'
        )
        ...
        validate_apps_dict['app0']['grantarchived_synthetic_bene_deduped_count'] = 3
        validate_apps_dict['app0']['grant_and_archived_synthetic_bene_deduped_count'] = 12
        ...
        validate_apps_dict['app1']['grant_and_archived_synthetic_bene_deduped_count'] = 9
        ...
        validate_apps_dict['app0']['grant_and_archived_synthetic_bene_deduped_count'] = 11
        ...
        validate_apps_dict['app1']['grant_and_archived_synthetic_bene_deduped_count'] = 8
        ...
        validate_apps_dict['app3']['grant_and_archived_synthetic_bene_deduped_count'] = 6
        ...
        for app_num in range(10, 12):
            app, user_dict = self._create_range_users_app_token_grant(
                start_fhir_id='7100000000000',
                count=3,
                app_name='app{}'.format(str(app_num)),
