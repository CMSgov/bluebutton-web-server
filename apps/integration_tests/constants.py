...
USERINFO_SCHEMA = {
    ...
    'required': ['email', 'family_name', 'given_name', 'iat', 'name', 'patient', 'sub'],
}
...
FHIR_META_SCHEMA = {
    ...
    'required': ['resourceType', 'date', 'publisher', 'fhirVersion', 'rest'],
}
...
EOB_READ_SCHEMA = {
    ...
    'type': 'object',
    'properties': {'resourceType': {'type': 'string'}, 'id': {'type': 'string'}, 'contained': {'type': 'array'}},
...
EXPECTED_LOGGING_EVENTS = [
    ...
    {'schema': LOG_MIDDLEWARE_MEDICARE_LOGIN_EVENT_SCHEMA, 'path': '/mymedicare/login'},
    {
        'schema': LOG_MIDDLEWARE_MEDICARE_CALLBACK_EVENT_SCHEMA,
        'path': '/mymedicare/sls-callback',
    },
    {'schema': LOG_MIDDLEWARE_AUTHORIZE_EVENT_SCHEMA, 'path_regex': '/v[12]/o/authorize/.+/'},
    {'schema': LOG_MIDDLEWARE_ACCESS_GRANT_EVENT_SCHEMA, 'path_regex': '/v[12]/o/authorize/.+/'},
    {
    ...
    {'schema': LOG_MIDDLEWARE_TESTCLIENT_FHIR_READ_EVENT_SCHEMA, 'path': '/testclient/PatientV2'},
    {
        # first Coverage
        'schema': LOG_MIDDLEWARE_FHIR_SEARCH_EVENT_SCHEMA,
        'path': '/v2/fhir/Coverage/',
    },
    {'schema': LOG_MIDDLEWARE_TESTCLIENT_FHIR_SEARCH_EVENT_SCHEMA, 'path': '/testclient/CoverageV2'},
    {
        # last Coverage
        'schema': LOG_MIDDLEWARE_FHIR_NAVIGATION_EVENT_SCHEMA,
        'path': '/v2/fhir/Coverage/',
    },
    {'schema': LOG_MIDDLEWARE_TESTCLIENT_FHIR_NAVIGATION_EVENT_SCHEMA, 'path': '/testclient/CoverageV2'},
    {
    ...
    {'schema': LOG_MIDDLEWARE_TESTCLIENT_FHIR_SEARCH_EVENT_SCHEMA, 'path': '/testclient/ExplanationOfBenefitV2'},
    {
        # last EOB
        'schema': LOG_MIDDLEWARE_FHIR_NAVIGATION_EVENT_SCHEMA,
        'path': '/v2/fhir/ExplanationOfBenefit/',
    },
    {'schema': LOG_MIDDLEWARE_TESTCLIENT_FHIR_NAVIGATION_EVENT_SCHEMA, 'path': '/testclient/ExplanationOfBenefitV2'},
    {
        # test client fhir links page
        'schema': LOG_MIDDLEWARE_EVENT_SCHEMA,
        'path': '/testclient/',
...
CLICK_BUTTON_GET_SAMPLE_TOKEN_V3 = {
    'display': 'Click button to get sample v3 authorization token',
    'action': Action.FIND_CLICK,
    'params': [30, By.LINK_TEXT, TESTCLIENT_BTN_GET_TOKEN_V3],
}
...
SEQ_QUERY_FHIR_RESOURCES_V2 = [
    ...
    WAIT_SECONDS,
    {
        ...
        'params': [
            20,
            By.TAG_NAME,
            LAB_FHIR_RESULTPAGE_H2,
            TESTCLIENT_RESOURCE_LABEL_FMT,
...
SEQ_USER_LOGIN = [
    ...
    {'display': 'Click login button', 'action': Action.FIND_CLICK, 'params': [30, By.CSS_SELECTOR, USER_LOGIN_BTN]},
]
...
COVERAGE_OPERATION_OUTCOME_DISAGNOSTICS = "Invalid Coverage ID format. Expected pattern like 'part-c-12345-H1234-001'."
INVALID_ID_OPERATION_OUTCOME_DIAGNOSTICS = 'ID is not a valid number'
INVALID_PATIENT_ID = '-120930918340ajhf-----'
INVALID_COVERAGE_ID = 'part-b__--123456789'

V3_FHIR_CALL_PREFIX = '/v3/fhir/'
