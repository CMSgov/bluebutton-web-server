...
class ApplicationListView(ListAPIView):
    ...
    An application that has active=False or with a label name = "internal-use"
    will be excluded from this view.
    """
    ...
    def get_queryset(self):
        queryset = Application.objects.exclude(active=False).exclude(applicationlabel__name='internal-use').order_by('name')
        return queryset
