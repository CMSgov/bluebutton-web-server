...
class Command(BaseCommand):
    help = 'Update Access Grants Per Application.Pass in a list of application ids.'

    def add_arguments(self, parser):
        parser.add_argument(
            '--applications', help='List of applications to update id, comma separated: eg. 1,2,3. Supersedes --all'
        )
