            ...
            if grant_type == 'client_credentials':
                ...
                if allow_client_credentials_call:
                    ...
                    try:
                        ...
                        id_match_payload_json = id_match_payload.dict()
                        log.info(id_match_payload_json)
                        headers = {
                        ...
                        patient_bundle = get_patient_match_response_json(url=url, json=id_match_payload_json, headers=headers, method="POST")
