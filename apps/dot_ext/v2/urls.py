...
base_urlpatterns = [
    url(r'^authorize/$', views.AuthorizationView.as_view(version=2), name="authorize-v2"),
    url(r'^authorize/(?P<uuid>[\w-]+)/$', views.ApprovalView.as_view(version=2), name="authorize-instance-v2"),
