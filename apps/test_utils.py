...
class HasMatchingProtectedResourceTest(TestCase):
    def setUp(self):
    ...
    def test_has_matching_protected_resource_returns_false(self) -> bool:
        """
    ...
    def test_has_matching_protected_resource_returns_true(self) -> bool:
        """
