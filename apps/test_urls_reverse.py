...
EXPECTED = {
    ...
    'mymedicare-sls-callback/1': '/mymedicare/sls-callback/1',
    'mymedicare-sls-callback/2': '/mymedicare/sls-callback/2',
...
URLS_NAMES = {
    ...
    "mymedicare-sls-callback/1": None,
    "mymedicare-sls-callback/2": None,
