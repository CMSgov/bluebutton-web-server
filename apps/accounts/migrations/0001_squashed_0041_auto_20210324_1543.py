    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_applications', models.BooleanField(default=False, help_text='Check this to allow the account to register applications.')),
                ...
                ('mfa_login_mode', models.CharField(blank=True, default='', max_length=5, null=True)),
                ...
                ('authorize_applications', models.BooleanField(default=False, help_text='Check this to allow the account to authorize applications.')),
