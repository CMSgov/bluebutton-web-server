...
def create_account(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                _('Your account was created. Please check your email to verify your account before logging in.'),
            )
        ...
        return render(request, 'registration/signup.html', {'name': name, 'form': SignupForm()})
...
def account_settings(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # the form had errors
            return render(request, 'account-settings.html', {'form': form, 'name': name})
    ...
    return render(request, 'account-settings.html', {'name': name, 'form': form})
