    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                _(
                    "Your account was created. Please "
            ...
            return render(
                request, "registration/signup.html", {"name": name, "form": form}
            )
    else:
        return render(
            request, "registration/signup.html", {"name": name, "form": SignupForm()}
        )
...
def account_settings(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # the form had errors
            return render(
                request, "account-settings.html", {"form": form, "name": name}
            )
