...
patient_response_v2 = {
    ...
    "link": [
        {
            "url": "http://localhost:8000/v2/fhir/Patient?_count=5&startIndex=0&_id=-20140000008325",
            "relation": "first"
        },
        {
            "url": "http://localhost:8000/v2/fhir/Patient?_count=5&startIndex=0&_id=-20140000008325",
        ...
        {
            "url": "http://localhost:8000/v2/fhir/Patient/?_count=5&_format=application%2Fjson%2Bfhir&_id=-20140000008325&startIndex=0",  # noqa
            "relation": "self"
        }
    ],
    "id": "4250e2c5-8956-40a1-9809-1be08ba542f7",
...
patient_response_v3 = {
    ...
    "link": [
        {
            "url": "http://localhost:8000/v3/fhir/Patient?_count=5&startIndex=0&_id=-20140000008325",
            "relation": "first"
        },
        {
            "url": "http://localhost:8000/v3/fhir/Patient?_count=5&startIndex=0&_id=-20140000008325",
        ...
        {
            "url": "http://localhost:8000/v3/fhir/Patient/?_count=5&_format=application%2Fjson%2Bfhir&_id=-20140000008325&startIndex=0",  # noqa
            "relation": "self"
        }
    ],
    "id": "4250e2c5-8956-40a1-9809-1be08ba542f7",
