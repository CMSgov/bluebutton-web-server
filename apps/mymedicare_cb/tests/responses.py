patient_response = {
    ...
    'entry': [
        {
            'resource': {
                'name': [{'given': ['Jane', 'X'], 'family': 'Doe', 'use': 'usual'}],
                'extension': [
                    {
                        'valueCoding': {
                ...
                'identifier': [
                    {'value': '-20140000008325', 'system': 'https://bluebutton.cms.gov/resources/variables/bene_id'},
                    {
                ...
                'id': '-20140000008325',
                'address': [{'state': '15', 'district': '999', 'postalCode': '99999'}],
                'gender': 'female',
                'birthDate': '2014-06-01',
            }
        }
    ],
    'meta': {'lastUpdated': '2019-06-27T08:17:11.811-04:00'},
}
