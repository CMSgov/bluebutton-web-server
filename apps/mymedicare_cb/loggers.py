...
def log_authenticate_start(auth_flow_dict, sls_status, sls_status_mesg, sls_subject=None,
    ...
    log_dict = {
        ...
        "sls_healthcheck_ssl": slsx_client.healthcheck_endpoint_ssl,
        "sls_signout_ssl": slsx_client.signout_endpoint_ssl,
        "sls_signout_status_code": slsx_client.signout_status_code,
        "sls_token_ssl": slsx_client.token_endpoint_ssl,
        "sls_token_status_code": slsx_client.token_status_code,
        "sls_userinfo_ssl": slsx_client.userinfo_endpoint_ssl,
