...
# https://verified.clearme.com/integrations/oauth2/auth?response_type=code&client_id={client_id}&state=teststate&redirect_uri={CLEAR_REDIRECT_URI}&scope=offline%20openid%20offline_access&code_challenge={code-challenge}&code_challenge_method=S256
...
# --data-urlencode 'redirect_uri={CLEAR_REDIRECT_URI}' \
...
def test_clear_integration_flow():
    ...
    client_id = os.getenv('CLEAR_CLIENT_ID', 'your-client-id-here')
