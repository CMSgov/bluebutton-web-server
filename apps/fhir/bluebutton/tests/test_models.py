...
class TestModels(BaseApiTest):
    ...
    def test_mutable_fhir_id(self):
        ...
        cw = Crosswalk.objects.get(user=user)
        self.assertEqual(cw.fhir_id(Versions.V2), "-20000000000001")
        self.assertEqual(cw.fhir_id(Versions.V3), "-30000000000001")
        cw.set_fhir_id("-20000000000002", Versions.V2)
        cw.set_fhir_id("-30000000000002", Versions.V3)
        self.assertEqual(cw.fhir_id(Versions.V2), "-20000000000002")
        self.assertEqual(cw.fhir_id(Versions.V3), "-30000000000002")
