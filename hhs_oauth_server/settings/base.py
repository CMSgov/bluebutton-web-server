...
CMS_SPLUNK_URL = os.getenv("CMS_SPLUNK_URL", "https://splunk.cloud.cms.gov")
...
PASSWORD_HASH_ITERATIONS = int(os.getenv("DJANGO_PASSWORD_HASH_ITERATIONS", "200000"))
...
if os.getenv("ENV_SPECIFIC_APPS", False):
    INSTALLED_APPS += os.getenv("ENV_SPECIFIC_APPS")

REST_FRAMEWORK = {
    "DEFAULT_THROTTLE_RATES": {
        "token": os.getenv("TOKEN_THROTTLE_RATE", "100000/s"),
...
if os.getenv("OPTIONAL_INSTALLED_APPS", False):
...
DATABASES = {
    "default": dj_database_url.config(
        default=os.getenv("DATABASES_CUSTOM", "sqlite:///{}/db.sqlite3".format(BASE_DIR))
    ),
}
...
EMAIL_USE_TLS = bool(os.getenv("DJANGO_EMAIL_USE_TLS", "True"))
EMAIL_USE_SSL = bool(os.getenv("DJANGO_EMAIL_USE_SSL", "False"))
...
APP_LOGO_WIDTH_MAX = os.getenv("DJANGO_APP_LOGO_WIDTH_MAX", "128")
APP_LOGO_HEIGHT_MAX = os.getenv("DJANGO_APP_LOGO_HEIGHT_MAX", "128")
...
FHIR_SERVER = {
    "FHIR_URL": os.getenv("FHIR_URL", "https://fhir.backend.bluebutton.hhsdevcloud.us"),
...
DEFAULT_SAMPLE_FHIR_ID = os.getenv("DJANGO_DEFAULT_SAMPLE_FHIR_ID", "-20140000008325")
...
if os.getenv("TARGET_ENV", "") in ["dev", "test", "impl", "prod"]:
