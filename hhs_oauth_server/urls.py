...
urlpatterns = [
    ...
    url(r'^v2/connect/userinfo', openidconnect_userinfo, {"ver": "v2"}, name='openid_connect_userinfo_v2'),
    url(r'^v2/fhir/metadata$', fhir_conformance, {"ver": "v2"}, name='fhir_conformance_metadata_v2'),
