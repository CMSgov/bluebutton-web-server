...
urlpatterns_v1 = [
    ...
    # connect/userinfo
    re_path(r'^v1/connect/userinfo', openidconnect_userinfo_v1, name='openid_connect_userinfo'),
    # dot_ext
    ...
    # openid_config
    path('v1/connect/.well-known/openid-configuration', openid_configuration_v1, name='openid-configuration'),
    # smart config
...
urlpatterns_v2 = [
    ...
    # openid_config
    path('v2/connect/.well-known/openid-configuration', openid_configuration_v2, name='openid-configuration-v2'),
    # smart config
